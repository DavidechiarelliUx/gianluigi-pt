...
const sections = [
  { icon: UserRoundCheck, title: "Dati che raccogliamo", text: "Nome, email, telefono (opzionale), dati di allenamento (esercizi, carichi, ripetizioni, RPE), sessioni completate, feedback e check-in settimanali facoltativi (energia, difficoltà e ostacoli)." },
  { icon: Server, title: "Come vengono usati", text: "I dati di allenamento e i check-in aiutano Gianluigi a seguire e adattare la scheda. Una bozza dell'allenamento può restare temporaneamente sul tuo dispositivo finché non viene sincronizzata. Non vendiamo i tuoi dati." },
